-- consultas_sql.sql
-- tabela sales_clean corresponde ao arquivo data_clean.csv que contém colunas:
...
-- cria uma tabela sales_june_2024 (arquivo sales_june_2024.csv) com registros de junho/2024.
